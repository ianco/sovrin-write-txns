...
```
cargo run ~/Projects/sovrin-write-txns/sovrin-staging-ledger/issuer-2-sign-schema.txt
```
...
```
cargo run ~/Projects/sovrin-write-txns/sovrin-staging-ledger/endorser-2-write-schema.txt
```
...
```
cargo run ~/Projects/sovrin-write-txns/sovrin-staging-ledger/issuer-3-create-cred-def.txt
```
...
```
cargo run ~/Projects/sovrin-write-txns/sovrin-staging-ledger/endorser-3-write-cred-def.txt
```
...
```
cargo run ~/Projects/sovrin-write-txns/sovrin-staging-ledger/issuer-4-export-wallet.txt
```
...
```
cargo run ~/Projects/sovrin-write-txns/sovrin-staging-ledger/issuer-5-import-wallet.txt
```
